...
class PhysicsTheoryPage extends StatefulWidget {
  const PhysicsTheoryPage({Key? key});

  @override
  State<PhysicsTheoryPage> createState() => _PhysicsTheoryPageState();
}

class _PhysicsTheoryPageState extends State<PhysicsTheoryPage> {
  @override

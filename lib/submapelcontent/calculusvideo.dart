...
class CalculusVideoPage extends StatefulWidget {
  const CalculusVideoPage({Key? key}) : super(key: key);

  @override
  State<CalculusVideoPage> createState() => _CalculusVideoPageState();
}
...
class _CalculusVideoPageState extends State<CalculusVideoPage> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/calculus.mp4')
      ..initialize().then((_) {
        setState(() {});
      });

...
class ChemistryVideoPage extends StatefulWidget {
  ...
  @override
  State<ChemistryVideoPage> createState() => _ChemistryVideoPageState();
}

class _ChemistryVideoPageState extends State<ChemistryVideoPage> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/chemistry.mp4')
      ..initialize().then((_) {
        setState(() {});
      });

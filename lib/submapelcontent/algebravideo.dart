...
class AlgebraVideoPage extends StatefulWidget {
  const AlgebraVideoPage({Key? key}) : super(key: key);

  @override
  State<AlgebraVideoPage> createState() => _AlgebraVideoPageState();
}

class _AlgebraVideoPageState extends State<AlgebraVideoPage> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/aljabar.mp4')
      ..initialize().then((_) {
        setState(() {});
      });

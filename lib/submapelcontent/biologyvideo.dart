...
class BiologyVideoPage extends StatefulWidget {
  const BiologyVideoPage({Key? key}) : super(key: key);

  @override
  State<BiologyVideoPage> createState() => _BiologyVideoPageState();
}

class _BiologyVideoPageState extends State<BiologyVideoPage> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/biology.mp4')
      ..initialize().then((_) {
        setState(() {});
      });

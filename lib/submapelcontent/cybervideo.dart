...
class CyberVideoPage extends StatefulWidget {
  const CyberVideoPage({Key? key}) : super(key: key);

  @override
  State<CyberVideoPage> createState() => _CyberVideoPageState();
}

class _CyberVideoPageState extends State<CyberVideoPage> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/cyber.mp4')
      ..initialize().then((_) {
        setState(() {});
      });

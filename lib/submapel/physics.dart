                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (builder) => const PhysicsTheoryPage()),
                            );
                          },
                          borderRadius: BorderRadius.circular(30),
                          child: const Center(
                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const PhysicsFormulaPage()),
                            );
                          },
                          borderRadius: BorderRadius.circular(30),
                          child: const Center(
                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (builder) => const PhysicsVideoPage()),
                            );
                          },
                          borderRadius: BorderRadius.circular(30),
                          child: const Center(

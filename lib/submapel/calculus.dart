...
import '../submapelcontent/calculusformula.dart';
import '../submapelcontent/calculustheory.dart';
import '../submapelcontent/calculusvideo.dart';
                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (builder) => const CalculusTheoryPage()),
                            );
                          },
                          borderRadius: BorderRadius.circular(30),
                          child: const Center(
                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const CalculusFormulaPage()),
                            );
                          },
                          borderRadius: BorderRadius.circular(30),
                          child: const Center(
                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (builder) => const CalculusVideoPage()),
                            );
                          },
                          borderRadius: BorderRadius.circular(30),
                          child: const Center(

                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (builder) => const ChemistryTheoryPage()),
                            );
                          },
                          borderRadius: BorderRadius.circular(30),
                          child: const Center(
                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const ChemistryFormulaPage()),
                            );
                          },
                          borderRadius: BorderRadius.circular(30),
                          child: const Center(
                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (builder) => const ChemistryVideoPage()),
                            );
                          },
                          borderRadius: BorderRadius.circular(30),
                          child: const Center(
